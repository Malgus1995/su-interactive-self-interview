...
// node_modules/@rpgjs/client/lib/Gui/React.js
var import_client = __toESM(require_client(), 1);
var import_react2 = __toESM(require_react(), 1);

// node_modules/@rpgjs/client/node_modules/nanostores/action/index.js
var lastAction = Symbol();
var actionId = Symbol();

// node_modules/@rpgjs/client/node_modules/nanostores/clean-stores/index.js
var clean = Symbol("clean");

// node_modules/@rpgjs/client/node_modules/nanostores/listen-keys/index.js
...
// node_modules/@rpgjs/client/node_modules/@nanostores/react/index.js
...
// node_modules/@rpgjs/client/lib/Gui/React.js
var RpgReactContext = (0, import_react2.createContext)({});
var useObjects = () => {
  const [objects, setObjects] = (0, import_react2.useState)([]);
  const { rpgObjects } = (0, import_react2.useContext)(RpgReactContext);
  (0, import_react2.useEffect)(() => {
    rpgObjects.pipe(map((objects2) => Object.values(objects2).map((obj) => obj.object))).subscribe(setObjects);
  }, []);
  return objects;
};
var useCurrentPlayer = () => {
  const { rpgCurrentPlayer } = (0, import_react2.useContext)(RpgReactContext);
  const currentPlayerRef = (0, import_react2.useRef)({});
  let _onChanges;
  ...
  return (0, import_react2.useSyncExternalStore)(subscribe, () => currentPlayerRef.current);
};
var useEventPropagator = () => {
...
var ReactGui = class {
  ...
  constructor(rootEl, parentGui) {
    ...
    this.app = (0, import_client.createRoot)(rootEl);
    this.clientEngine = parentGui.clientEngine;
    this.renderer = this.clientEngine.renderer;
    const GuiTooltip = (ui) => {
      return () => {
        const [_tooltip, setTooltip] = (0, import_react2.useState)([]);
        (0, import_react2.useEffect)(() => {
          var _a;
        ...
        return parentGui.tooltipFilter(_tooltip).map((sprite) => (0, import_react2.createElement)("div", {
          style: parentGui.tooltipPosition({ x: sprite.position.x, y: sprite.position.y }),
          key: sprite.id
        }, (0, import_react2.createElement)(ui.gui, {
          spriteData: sprite,
          ...ui.data || {}
        })));
      };
    ...
    const GuiWrapper = () => {
      const [_gui, setGui] = (0, import_react2.useState)([]);
      (0, import_react2.useEffect)(() => {
        this._gui.subscribe((gui) => setGui(gui));
      }, []);
      return (0, import_react2.createElement)(RpgReactContext.Provider, {
        value: parentGui.getInjectObject()
      }, ..._gui.filter((ui) => ui.display && !ui.attachToSprite).map((ui) => (0, import_react2.createElement)("div", {
        key: ui.name,
        style: { "pointerEvents": "auto" }
      }, (0, import_react2.createElement)(ui.gui, ui.data || {}))), ..._gui.filter((ui) => ui.display && ui.attachToSprite).map((ui) => (0, import_react2.createElement)("div", {
        key: ui.name,
        style: { "pointerEvents": "auto" }
      }, (0, import_react2.createElement)(GuiTooltip(ui)))));
    };
    this.app.render((0, import_react2.createElement)(GuiWrapper));
  }
  set gui(val) {
    let array = [];
    for (let key in val) {
...
function RpgGame({ onReady, modules }) {
  ...
  return (0, import_react2.createElement)("div", { id: "rpg", ref: divRef });
}
export {
  ReactGui,
  RpgGame,
...
react-dom/cjs/react-dom.development.js:
   ...
   *)
*/
//# sourceMappingURL=React-Q7FWRKBS.js.map
